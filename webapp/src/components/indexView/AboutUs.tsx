...
export const AboutUs = () => {
    return (
        <Box sx={{ 
            ...
            <Typography variant="body2" sx={{marginTop: "2em"}}>Proyecto realizado para la asignatura de Arquitectura del Software, Universidad de Oviedo - Curso 22/23</Typography>
