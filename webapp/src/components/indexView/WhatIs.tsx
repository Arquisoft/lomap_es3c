...
export const WhatIs = () => {
    return (
        <Box sx={{ 
            ...
            <Typography variant="body1" sx={{ mb: 4 }}><strong>LoMap</strong> es una aplicación de mapas personalizados.</Typography>
            <Typography variant="body1" sx={{ mb: 4, marginLeft: "1em", marginRight: "1em" }}>En <strong>LoMap</strong> puedes añadir tus lugares favoritos, para que puedas consultarlos siempre que quieras. De esta manera, tendrás tus rincones más especiales, a un simple click. </Typography>
