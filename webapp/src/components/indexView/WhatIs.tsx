...
export const WhatIs = () => {
    return (
        <Box sx={{ 
            ...
            <Typography variant="body1" sx={{ mb: 4, marginLeft: "1em", marginRight: "1em" , marginBottom: "0.25em" }}>De esta manera, tendrás tus rincones más especiales, a un simple click. </Typography>
