...
la url en la que se despliega es: [https://arquisoft.github.io/lomap_es3c/](https://arquisoft.github.io/lomap_es3c/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/lomap_es3c/](https://arquisoft.github.io/lomap_es3c/) necesitamos ejecutar `npm run deploy`.
