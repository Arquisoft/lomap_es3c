...
[![Actions Status](https://github.com/arquisoft/lomap_es3c/workflows/CI%20for%20LOMAP_ES3C/badge.svg)](https://github.com/arquisoft/lomap_es3c/actions)
...
If you want to execute the project you will need [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) and [Docker](https://docs.docker.com/get-docker/). Make sure the three of them are installed in your system. Download the project with `git clone https://github.com/arquisoft/lomap_es3c`. The fastest way to launch everything is with docker:
```bash
...
deploy:
    ...
    - name: Deploy over SSH
      ...
      with:
        ...
        command: |
          wget https://raw.githubusercontent.com/arquisoft/lomap_es3c/master/docker-compose-deploy.yml -O docker-compose.yml
          docker-compose stop
          docker-compose rm -f
          docker-compose pull   
          docker-compose up -d
